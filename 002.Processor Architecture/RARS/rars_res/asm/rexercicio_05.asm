...
main:
	...
	addi s4, zero, 1 # inicializando j = 1 para varrer p array de 1 em 1
	addi s3, zero, 0 # inicializando i = 0
	
Loop:	add t1, s3, s3 # t1 = 2*i
	add t1, t1, t1 # t1 = 4*1
	add t1, t1, s6 # t1 = end.base + 4.i (deslocamento) = end.save[i]
	lw  t0, 0(t1) # t0 = save[i]
	bne t0, s5, Exit # se save[i] != k go to Exit
	add s3, s3, s4 # i = i + j
